...
// import { ShopContext } from '../stores'
...
//         Adresse: z.string().min(1, 'Adress is required'),
//         Zip: z.string().min(1, 'Zip is required'),
//         City: z.string().min(1, 'City is required'),
//         Country: z.string().min(1, 'Country is required'),
//         Cash: z.string().min(1, 'Cash is required'),
//         EmoneyNumber: z.string().min(1, 'EmoneyNumber is required'),
//         EmoneyPin: z.string().min(1, 'EmoneyPin is required'),
//       });
